...
<List title="Um pouco sobre vocês"
  items={[
    'Básico de HTML, CSS, JavaScript?',
    'Já trabalha ou faz estágio na área?',
    'Backend vs Frontend?',
    'Fullstack Developer?',
    'Já usou React?',
    'Já usou alguma outra framework Frontend? (Angular, Vue, etc...)'
  ]} 
/>
...
```notes
Pra que seja possível criar aplicações utilizando JavaScript foram desenvolvidas várias frameworks
```
...
```notes
Aprenda uma única vez, escreva onde quer que seja
```

---

<List title="React é como uma interface Java"
  items={[
    'ReactDOM',
    'ReactNative',
    'mdx-deck',
